...
<div className="carousel-helper col-3 col-sm-2 col-md-1 ">
      ...
      <div className="col-9 col-sm-10 col-md-11 p-0 d-flex align-items-around ">
        {aboutIndex === 1 ? (
          <div key={aboutIndex} className="row animate__animated animate__fadeIn d-flex  p-0" style={{overflow:'hidden'}}>
            <div className="scene-container col-12 col-md-5 col-lg-4 animate__animated animate__fadeInUp">
              <div className="scene " >
            ...
            <div className="col-12 col-md-7 col-lg-8 d-flex align-items-center animate__animated animate__fadeInUp">
          ...
          <div key={aboutIndex} className="row animate__animated animate__fadeIn d-flex m-0 p-0" style={{overflow:'hidden'}}>

            <div className="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-4 photograph d-flex align-items-center justify-content-center">
              <img src={image} alt="logo" className="carousel-photo animate__animated animate__fadeInUp" style={{ borderRadius: 5 }} />
            </div>
            <div className="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-8 align-self-center about-me ">
              <div key={aboutIndex} className="col-12  ">
                ...
                <p className="carousel-text animate__animated animate__fadeInUp">
                  {" "}
                  {text}
                </p>
              </div>
