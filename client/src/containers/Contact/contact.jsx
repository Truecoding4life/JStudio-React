    ...
    <section>
        ...
        <Alert
          icon={
            <CheckCircleOutlineIcon
              style={{ color: "black", marginTop: "6px", fontWeight: "bold" }}
            />
          }
          onClose={() => {
            setAlert(false);
      ...
      {Messaging ? (
        ...
        <div className="pt-5 contact-container container">
          <div
            className="col-md-12 align-self-center chat-box p-4"
            style={{ borderColor: buttonBorderTheme }}
          >
            <div className="row">
              <div className="col-12">
                <p
                  ...
                  style={{
                    ...
                    color: textColor,
                    fontSize: "30px", // Add this line to set a default font size for all screen sizes
                  }}
                >
            ...
            <div
              className="row row-cols-2 d-flex flex-row"
