export default function ResumePage() {
    return(
        <div className="container mt-5">
            ...
            <a href="https://docs.google.com/document/d/1nRdWUr0BJAV-i-XUV5W1z-jJe613ZwSLYrtNlvE0BuY/edit?usp=sharing" className="btn bg-primary mt-3 text-white"> Download my resume</a>
        </div>
    )
}
